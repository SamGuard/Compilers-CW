...
add $9, $0, 0
seq $10, $8, $9 # Maths and Logic
sw $10, 12($16) # Maths and Logic
...
sw $9, 0($8) # Set offset for closure
sw $16, 16($8) # Set stack pointer for closure
sw $18, 0($16) # Set func getFunc definition
add $18, 8 # Increment closure counter
...
lw $8, 8($19) # getArg: a, memory offset: 1
...
jr $ra  # Return
_L5:
lw $8, 0($16) # getArg: getFunc, memory offset: 0
sw $8, 16($16) # Set f
add $16, $16, 8 # Move scope up
j _L2 # Jump to %s
_L3:
add $16, $16, -4 # Move scope down
la $8, closures # Load closure space address
add $8, $8, $18
add $9, $0, 16 # Put offset into register
sw $9, 0($8) # Set offset for closure
sw $16, 16($8) # Set stack pointer for closure
sw $18, 0($16) # Set func getFunc2 definition
add $18, 8 # Increment closure counter
j _L9 # Skip function as this is the definiton
getFunc2:
add $16, $16, -12 # Move scope down
sw $30, 0($16) # Save previous chain location into memory
add $8, $0, 1
...
jr $ra  # Return
_L9:
lw $8, 0($16) # getArg: getFunc2, memory offset: 0
sw $8, 16($16) # Set f
add $16, $16, 8 # Move scope up
_L2:
...
lw $8, 8($16) # getArg: f, memory offset: 2
...
jr $ra  # Return
_L1:
j _L13 # Skip function as this is the definiton
main0:
add $16, $16, -28 # Create new scope
